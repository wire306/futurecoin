...
// Copyright (c) 2011-2013 futurecoin Developers.
...
uint256 hashGenesisBlock("0x454b7ce073d532eea5b91177b93dcbf3e37b481e45f3ab2398ef82a358204f99");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // futurecoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "futurecoin Signed Message:\n";
...
static const int64 nTargetTimespan =  100 * 60; // futurecoin: 100 blocks
static const int64 nTargetSpacing = 1 * 60; // futurecoin: 60 seconds
...
// Digitalcoin difficulty adjustment protocol switch
   ...
   int64 nInterval = fInflationFixProtocol? (nTargetTimespanCurrent / nTargetSpacing) : (nTargetTimespanCurrent / (nTargetSpacing / 2));
    ...
    // futurecoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal futurecoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "futurecoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2fbe2f1617706b805bf5cdc97be5db9839169c4fd0824d2a9b503f505ab7d6bc");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "France's top court reinstates ban on comic Dieudonne";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1389286680;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 5002856;

        if (fTestNet)
        {
            block.nTime    = 1389286680;             //test net not supported
            block.nNonce   = 4267872;
        }
		...
		assert(block.hashMerkleRoot == uint256("0xc545b75c9b64a0c2ce64a8acf439428eff403c25f82ef5435ef0862b9e535158"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // futurecoin: increase each by adding 2 to bitcoin's value.
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // futurecoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
